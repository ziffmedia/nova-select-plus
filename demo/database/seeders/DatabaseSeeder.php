...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $batonRouge = City::create(['name' => 'Baton Rouge', 'state_id' => $louisiana->id]);
        City::create(['name' => 'New Orleans', 'state_id' => $louisiana->id]);
        ...
        $louisiana->update(['capital_city_id' => $batonRouge->id]);
    }
}
